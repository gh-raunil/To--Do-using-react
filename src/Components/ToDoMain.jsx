  ...
  return (
    <>
      <div className="flex md:justify-start items-center flex-col w-[100%] h-[100%] bg-gradient-to-bl to-[#3f87a6] from-[#ebf8e1] rounded-xl shadow-2xl rounded-br-4xl rounded-tl-4xl shadow-blue-400 p-5">
        ...
        <div className="w-[110%] md:w-[100%] max-h-[500px] border border-gray-400 rounded-2xl flex flex-col overflow-y-hidden justify-center items-center bg-white/10 backdrop-blur-3xl pb-5 p-">
          <div className="w-[95%] flex justify-between items-center px-3 py-1 bg-white/30 backdrop-blur-md rounded-lg mt-5 mb-3">
            <input onChange={(e) => settask(e.target.value)} value={task} type="text" className="p-1 w-50 sm:w-100 focus:outline-none" placeholder="Your Task" />
            <button onClick={addTask} className="pr-2 p-2 ">Add</button>
          </div>
