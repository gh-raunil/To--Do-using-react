...
const ToDoStart = ({onClose}) => {
  return (
    <>
      <div className='flex md:justify-center items-center flex-col w-[100%] h-[50%] md:h-[100%] bg-gradient-to-bl to-[#3f87a6] from-[#ebf8e1] rounded-xl shadow-2xl shadow-blue-400 rounded-tr-full rounded-bl-4xl p-5 md:p-10:pt-2'>
