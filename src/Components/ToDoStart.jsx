...
const ToDoStart = ({onClose}) => {
  return (
    <>
      <div className='flex md:justify-center items-center flex-col w-[100%] h-[50%] md:h-[100%] bg-gradient-to-bl to-[#3f87a6] from-[#ebf8e1] shadow-2xl shadow-blue-400 rounded-tr-[100rem] rounded-4xl p-5 md:p-10:pt-2'>
        <div className='relative flex flex-col justify-center items-center h-[100%] w-[100%]'>  
          <div className='text-center text-lg'>
            ...
            <p className='font-thin text-sm md:text-xl'>Manage your tasks efficiently</p>
          </div>
